...
#### TASKS
Задача 1: Жанры с наибольшим числом фильмов <br>
...
Задача 2: Средний рейтинг фильмов по жанрам <br>
...
Задача 3: Жанры фильмов в релизах по годам <br>
...
Задача 4: Жанры, в которых выпущено более 5 фильмов: <br>
Напишите запрос, который найдет жанры, в которых было выпущено более 5 фильмов.

Задача 5: Рейтинг и количество фильмов по годам <br>
...
Задача 6: Жанры, наиболее часто сочетающиеся <br>
Определить пары жанров, которые наиболее часто сочетаются в одном фильме. Вывести названия пар жанров и количество фильмов для каждой пары в порядке убывания количества фильмов. <br>
Ожидаемый результат: <br>
<img src="https://github.com/practicetasks/sql_movies_schema/assets/122010324/6872fb5b-6cdb-4831-a181-173f3fe9869e" width=350>

Задача 7: Фильмы с высоким рейтингом по жанру <br>
Для заданного жанра вывести список фильмов этого жанра с рейтингом выше определенного значения (например, 8.0). Вывести название фильма, год релиза и рейтинг.

Задача 8: Фильмы с наивысшим и наименьшим рейтингом: <br>
Напишите запрос, который найдет название и рейтинг самого высоко и самого низко оцененных фильмов.

Задача 9: Топ рейтинговых фильмов среди разных жанров <br>
Для каждого жанра найти фильм с наибольшим рейтингом. Вывести название жанра, название фильма и его рейтинг.

Задача 10: Жанры, не представленные в определенном году <br>
Для заданного года релиза выяснить, какие жанры отсутствуют. Вывести список отсутствующих жанров.
