...
Задача 5: Жанры, в которых выпущено более 5 фильмов: <br>
Напишите запрос, который найдет жанры, в которых было выпущено более 5 фильмов.

Задача 6: Рейтинг и количество фильмов по годам <br>
...
Задача 7: Жанры, наиболее часто сочетающиеся <br>
...
Задача 8: Фильмы с высоким рейтингом по жанру <br>
...
Задача 9: Фильмы с наивысшим и наименьшим рейтингом: <br>
Напишите запрос, который найдет название и рейтинг самого высоко и самого низко оцененных фильмов.

Задача 10: Топ рейтинговых фильмов среди разных жанров <br>
