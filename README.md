...
Задача 3: Жанры фильмов в релизах по годам
...
Задача 4: Жанры, в которых выпущено более 5 фильмов:
Напишите запрос, который найдет жанры, в которых было выпущено более 5 фильмов.

Задача 5: Рейтинг и количество фильмов по годам
...
Задача 6: Жанры, наиболее часто сочетающиеся
Определить пары жанров, которые наиболее часто сочетаются в одном фильме. Вывести названия пар жанров и количество фильмов для каждой пары в порядке убывания количества фильмов.
...
Задача 9: Топ рейтинговых фильмов среди разных жанров
Для каждого жанра найти фильм с наибольшим рейтингом. Вывести название жанра, название фильма и его рейтинг.

Задача 10: Жанры, не представленные в определенном году
